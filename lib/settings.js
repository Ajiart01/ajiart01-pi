module.exports = {
    port: '1405',//Atur Sesukamu
    limitCount: 100,//Limit User
    limitPremium: 99999,//Limit Prem User
    expiredTokenDb: 3600,
    host: 'https://api.marinkitagawa.site',//Domain Web Api mu
    profilePath: "/images/favicon.png",
    myEmail: 'marin.kitagawa.officiall@gmail.com',//Isi Email
    passEmailApp: 'ixvowdttyihfjmve',//Isi Key Email Di Yt Zeeone Ada
    site_key: '6LdKCKUfAAAAAITqbEYZvWVbdmGi2a2Z2JE2sIgW',
    secret_key: '6LdKCKUfAAAAAPHhp5BR6z_DtKNe5F1e78SmQdrR',
    dbURI: 'mongodb+srv://marinkitagawa:johannes123@restapi.pbjm0nh.mongodb.net/?retryWrites=true&w=majority',
